...
int read_label_file(AVFilterContext *context,
...
int read_categories_file(AVFilterContext *context,
...
int get_category_label_counts(CategoryClassifcationContext *cat_ctx,
                                     int **label_counts)
{
...
CategoryContext *get_best_category(CategoriesContext *categories_ctx,
                                          float *probabilities)
{
